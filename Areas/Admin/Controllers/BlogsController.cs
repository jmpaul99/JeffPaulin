...
namespace JeffPaulin.Areas.Admin.Controllers
{
    ...
    public class BlogsController : Controller
    {
        ...
        {
            Blog b = new Blog() { Active = true, CreatedDate = DateTime.Now };
            return View(b);
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,BlogName,CreatedDate,LastPostDate,BlogHeader,BlogSubHeader,BlogDescription,Active")] Blog blog)
        {
