...
namespace JeffPaulin.Areas.Admin.Controllers
{
    ...
    public class OrganizationsController : Controller
    {
        ...
        public OrganizationsController(jpContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,OrganizationName,OrganizationDescription,CreatedDate,Active")] Organization organization)
        {
